...
The completed dataset provides meaningful insight into financial and macroeconomic behavior over the 2015–2024 period. Monthly S&P 500 returns averaged a little over 1% during this timeframe, but the distribution of returns was far from stable, with significant volatility during the early months of the COVID-19 pandemic. This period featured some of the most dramatic single-month declines and recoveries in modern market history, which can be clearly seen within the descriptive statistics and visualizations. Macro indicators displayed more gradual, predictable movements during normal economic conditions, but each showed a pronounced disruption during 2020, unemployment spiked to historic highs, industrial production fell sharply, and retail sales experienced sudden contraction followed by rapid rebound as policy interventions were introduced.

Correlation analysis revealed that most macroeconomic indicators exhibited moderate internal relationships. Industrial production and retail sales, for example, showed a strong positive correlation, reflecting the fact that both variables respond similarly to consumer demand and broader economic cycles. However, when examining correlations between these indicators and S&P 500 returns, the relationships were noticeably weaker. The strongest correlation with returns was still modest and did not indicate a consistent linear relationship. This aligns with financial theory: equity markets are forward-looking, meaning they often incorporate economic expectations before official macroeconomic data is released.

The OLS regression model further reinforced these results. The model explained roughly 9% of the variation in monthly stock returns, a relatively small proportion. Retail sales growth emerged as the only statistically significant predictor of S&P 500 returns, suggesting that sudden changes in consumer purchasing behavior may convey information relevant to market sentiment. Unemployment changes approached statistical significance, indicating that deteriorating labor-market conditions may be somewhat associated with market behavior, although the relationship was not strong enough to serve as a reliable predictor. GDP growth, CPI inflation, and industrial production growth were not significant in the model, reflecting their weaker short-term connection to equity performance at a monthly frequency.

The lagged macroeconomic indicators performed even worse in predictive models. The lagged regression saw its explanatory power drop to around 5–6%, suggesting that past values of macro indicators offer little information about future market returns. This finding supports the semi-strong form of the “Efficient Market Hypothesis”, which argues that publicly available economic information is quickly priced into markets, leaving limited room for systematic prediction based on macro data alone.

To investigate the hypothesis that macro–market relationships strengthen during periods of stress, a recession-focused subset of the data (March–May 2020) was analyzed. In contrast to the full-sample results, unemployment changes displayed a strong positive correlation with S&P 500 returns during this period, and correlations among macro variables intensified broadly. This suggests that during economic crises, markets react more directly to official economic releases, perhaps due to heightened uncertainty and rapidly evolving expectations.
Overall, the findings indicate that macroeconomic indicators serve more effectively as context for understanding long-term economic conditions rather than as tools for predicting short-term stock market returns. The relationships observed are meaningful but limited, underscoring the complexity and forward-looking nature of financial markets.
